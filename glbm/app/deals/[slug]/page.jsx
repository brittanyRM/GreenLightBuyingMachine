...
export default function DealPage({ params }) {
  ...
  const { deal, rooms, comps, market, orgRows, documents } = bundle;
  ...
  return (
    <div className="min-h-screen bg-neutral-100 font-sans">
      ...
      <div className="mx-auto max-w-6xl">
        {tab === "sketch" && (
          <ConversionSketch deal={deal} initialRooms={rooms} market={market} onSaved={load} />
        )}
        {tab === "proforma" && (
        ...
        {tab === "flyer" && (
          <div className="p-4 sm:p-8">
            ...
            <div className="bg-white shadow-xl">
              <DealFlyer deal={deal} rooms={rooms} market={market} comps={comps} orgRows={orgRows} />
            </div>
          </div>
        )}
        {tab === "email" && (
